 ...
 *------------------------------------------------------------------
 *
 * $Source: /home/kde/kdeutils/kfloppy/e2fs/lib/ss/test_ss.c,v $
 * $Revision: 1.1.1.1 $
 * $Date: 1997/11/27 01:43:19 $
 * $State: Exp $
 * $Author: wuebben $
 * $Locker:  $
 *
 * $Log: test_ss.c,v $
 * Revision 1.1.1.1  1997/11/27 01:43:19  wuebben
 *
 *
...
static char const rcsid_test_c[] =
    "$Header: /home/kde/kdeutils/kfloppy/e2fs/lib/ss/test_ss.c,v 1.1.1.1 1997/11/27 01:43:19 wuebben Exp $";
#endif /* lint */
