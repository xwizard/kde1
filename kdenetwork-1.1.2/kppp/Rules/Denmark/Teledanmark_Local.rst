################################################################
# Danish rate ruleset for local calls (Nærpris)                #
...
# Minute taxes in off-peak hours: 0.145 DKR/Min
# Minute taxes in peak hours: 0.29 DKR/Min
...
# Off-peak: 0.145 DKR/Min (Calculated per second)
default=(0.0024166, 1)

# Peak hours: 0.29 DKR/Min
on (monday..saturday) between (8:00..19:29) use (0.004833, 1)

# National Holidays:

# Newyear (0.145 DKR/Min)
on (01/01) between () use (0.0024166, 1)
# "Skærtorsdag" (0.145 DKR/Min)
on (easter-3) between () use (0.0024166, 1)
# "Langfredag" (0.145 DKR/Min)
on (easter-2) between () use (0.0024166, 1)
# "2. påskedag" (0.145 DKR/Min)
on (easter+1) between () use (0.0024166, 1)
# "St. bededag" (0.145 DKR/Min)
on (easter+26) between () use (0.0024166, 1)
# "Kristi himmelfart" (0.145 DKR/Min)
on (easter+39) between () use (0.0024166, 1)
# "2. pinsedag" (0.145 DKR/Min)
on (easter+50) between () use (0.0024166, 1)
# Christmas day (0.145 DKR/Min)
on (12/25) between () use (0.0024166, 1)
# 2.nd christmas day (0.145 DKR/Min)
on (12/26) between () use (0.0024166, 1)
