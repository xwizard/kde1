...
#############################################
# 7-22 1 impuls svakih 60 sekundi
# 22-7 1 impuls svakih 120 sekundi
#############################################

on (monday..sunday) between (0:00..6:59) use (0.1677, 120)
on (monday..saturday) between (7:00..21:59) use (0.1677, 60)
on (monday..saturday) between (22:00..23:59) use (0.1677, 120)
