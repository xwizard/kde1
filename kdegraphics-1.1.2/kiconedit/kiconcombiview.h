...
#ifndef _KICONCOMBIVIEW_H
#define _KICONCOMBIVIEW_H

#include "kfileinfocontents.h"
#include "knewpanner.h"

class KIconCombiView: protected KNewPanner, public KFileInfoContents
{
    Q_OBJECT
...
public:
    ...
    KIconCombiView( FileView dirs, FileView files, 
