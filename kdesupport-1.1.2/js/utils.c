...
/*
 * $Source: /home/kde/kdesupport/js/utils.c,v $
 * $Id: utils.c,v 1.1.1.1 1998/08/09 21:05:34 kulow Exp $
 */
...
js_vm_to_string (JSVirtualMachine *vm, const JSNode *n, JSNode *result_return)
{
  ...
  JSNode *nnoconst = (JSNode *) n; /* toString methods behave `constantly'
				      so no panic here. */
  JSSymbol s_toString = js_vm_intern (vm, "toString");
  ...
  switch (n->type)
    ...
    default:
      fprintf (stderr, "cows learned to fly: n->type=%d\n", n->type);
      tostring = "XXX-bug-XXX";
      break;
    }
