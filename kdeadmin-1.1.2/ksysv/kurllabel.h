...
*/
/*
 * $Id: kurllabel.h,v 1.4 1999/01/27 12:07:32 putzer Exp $
 *
 * $Log: kurllabel.h,v $
 * Revision 1.4  1999/01/27 12:07:32  putzer
 * KSysV should be compiled again.
 * Re-added kurllabel.* => this fixes the segfault in the about dialog
 * (strange thing...)
 *
